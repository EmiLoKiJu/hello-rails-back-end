...
class GreetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create greeting' do
    assert_difference('Greeting.count') do
      post greetings_url, params: { greeting: { text: @greeting.text, user_id: @greeting.user_id } }, as: :json
    end
  ...
  test 'should update greeting' do
    patch greeting_url(@greeting), params: { greeting: { text: @greeting.text, user_id: @greeting.user_id } }, as: :json
    assert_response :success
  end
